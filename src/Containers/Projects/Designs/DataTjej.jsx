  ...
  return (
    <div className='portfolio__solwe'>
        ...
        <div className = "portfolio__projects" id = "reverse">
            <div className = "portfolio__projects-right" id ="datatjej2" style={{ backgroundImage: `url(${background})`, 
        ...
        <div className ="naturglass_image" id="datatjej3"><img alt ="img" src={datatjej}></img></div>
    </div>
  )
}
