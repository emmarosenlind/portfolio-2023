      ...
      <div className = "portfolio__projects">
        ...
        <div className ="portfolio__projects-left">
          ...
          <div className ="portfolio__projects-left_content">
            ...
            <h1>From Excel to SaaS: Leading the Design of an Advanced Analysis Tool</h1>
            <p id="ingress">In an effort to ease the production of ESG analysis, I led the design of a SaaS platform that replaces traditional Excel spreadsheets. This innovative solution streamlines data management and enhances collaboration for users seeking to conduct thorough ESG analyses. By focusing on user-centric design, we created a tool that meets the evolving needs of businesses committed to sustainability.</p>
              <div className ="portfolio__projects-left_content-description">
                <h2>DURATION</h2>
                <p>Nine months</p>
                <h2>TOOLS</h2>
                <p>Figma, Material UI, FigJam, Flow Chart</p>
              </div>
          </div>
        </div>

        <div className = "portfolio__projects-right" style={{ backgroundColor: "var(--sustainax-color)" }}>
            <div className="portfolio__projects-right_img" ><img src ={logo} alt = "schysst käk"></img></div>
        </div>
      </div>
