  ...
  return (
    ...
    <div className='portfolio__education'>
        ...
        <table>
            ...
            <tr>
                <td>Human-Computer Interaction with Emphasis on Cognition and Design</td>
                <td id = "hide">Undergraduate</td>
                <td id="points">7.5 hp</td>
            </tr>
            <tr>
        ...
        <table>
            ...
            <tr>
                <td>Product Development in Media Technology using the "Design-build-test" method</td>
                <td id = "hide">Graduate</td>
                <td id="points">7.5 hp</td>
            </tr>
            <tr>
